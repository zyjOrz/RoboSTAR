...
from .vocabulary import RobotSTARVocabulary, token_contract
...
def _checkpoint_payload(
    ...
    return {
        "version": "robotstar_fsq_c2f_mt5_large_v1",
...
def main() -> None:
    ...
    model = RobotSTARGenerator(cfg, vocab, backbone_init="pretrained").to(device)
    ...
    if is_main() and args.wandb:
        ...
        wandb_run = wandb.init(project="RobotSTAR", config={**values, "world_size": world})
    if is_main():
        write_json(
