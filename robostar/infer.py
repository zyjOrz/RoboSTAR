...
def main() -> None:
    ...
    parser.add_argument("--model", default="Ivystream/RoboSTAR")
    ...
    generator, vocab = RoboSTARGenerator.from_pretrained(root, base_model=args.base_model, device=device)
    generator.eval()
    tokenizer = RoboSTARTokenizer.from_pretrained(root, device=device).eval()
